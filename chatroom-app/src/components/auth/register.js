...
const Register = () => {
  ...
  const Check = ({ ok, label }) => (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '.85rem', color: ok ? 'var(--primary)' : 'var(--text-secondary)' }}>
      <div style={{ width: 18, height: 18, borderRadius: '50%', background: ok ? 'var(--primary)' : 'rgba(255,255,255,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        <div className="slide-up" style={{ width: '100%', maxWidth: 440 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: 'linear-gradient(135deg, var(--primary), var(--accent))', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16, boxShadow: '0 8px 32px rgba(99,102,241,.25)' }}>
          ...
          {/* Card */}
          <div className="cr-card" style={{ padding: '32px 28px', background: 'rgba(255,255,255,.05)', backdropFilter: 'blur(24px) saturate(1.4)', WebkitBackdropFilter: 'blur(24px) saturate(1.4)' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Requirements */}
              <div style={{ display: 'flex', gap: 20, marginBottom: 24, padding: '10px 14px', background: 'rgba(255,255,255,.04)', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(255,255,255,.06)' }}>
